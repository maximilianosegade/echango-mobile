                        ...
                        '<div class="ion-google-place-container modal">',
                            '<div class="bar bar-header item-input-inset">',
                                '<label class="item-input-wrapper">',
                                    ...
                                    '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="' + (attrs.searchPlaceholder || 'Ingrese la dirección o el código postal') + '">',
                                '</label>',
                    ...
                    popupPromise.then(function(el){
                        ...
                        scope.$watch('searchQuery', function(query){
                            ...
                            searchEventTimeout = $timeout(function() {
                                ...
                                //req.bounds ='-26.3721,-51.28|-55.14,-74.83' ;
                                var sw = new google.maps.LatLng(-55.14,-74.83);
                                var ne = new google.maps.LatLng(-26.3721,-51.28);
